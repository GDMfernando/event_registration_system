...
<head>
    <meta charset="UTF-8">
    <title>Modern Art Exhibition - Event Details</title>
...
<body>
    ...
    <main class="container">
        <div class="details-container">
            <img src="uploads/event_images/event_img_695ffda3e92ca7.86628308.jpg" class="event-header-img"
                alt="Modern Art Exhibition">

            <h1 class="event-title">Modern Art Exhibition</h1>
            <div class="event-info-meta">
                <span>Art</span> |
                <span>Nelum Pokuna Mahinda Rajapaksa Theatre</span> |
                <span>Downtown Gallery</span>
            </div>

            <div class="event-date-badge">
                <i class="far fa-calendar-alt"></i> Date: 2026-02-28
            </div>
            ...
            <a href="user/booking/seat_plan.php?event_id=9993" class="buy-tickets-btn">Buy Tickets Now</a>
        </div>
    </main>
