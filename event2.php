...
<head>
    <meta charset="UTF-8">
    <title>Summer Music Festival - Event Details</title>
...
<body>
    ...
    <main class="container">
        <div class="details-container">
            <img src="uploads/event_images/event_img_695d545b5fdb38.28900618.jpg" class="event-header-img"
                alt="Summer Music Festival">

            <h1 class="event-title">Summer Music Festival</h1>
            <div class="event-info-meta">
                <span>Concerts</span> |
                <span>Viharamahadevi Amphitheatre</span> |
                <span>City Park Arena</span>
            </div>

            <div class="event-date-badge">
                <i class="far fa-calendar-alt"></i> Date: 2026-09-13
            </div>
            ...
            <a href="user/booking/seat_plan.php?event_id=9991" class="buy-tickets-btn">Buy Tickets Now</a>
        </div>
    </main>
