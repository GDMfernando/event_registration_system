...
<body>
    ...
    <header class="header">
        <nav class="nav">
            <div class="nav-left">
                <a href="<?php echo isset($_SESSION['user_id']) ? 'logged_home.php' : 'home.php'; ?>" class="nav-link">Home</a>
            ...
            <div class="nav-right">
                ...
                <?php else: ?>
                        <span class="welcome-text" style="color: white; margin-right: 15px; font-weight: 600;">Welcome, <?php echo htmlspecialchars($user_name); ?>!</span>
    ...
    <main class="container">
        <div class="details-container">
            ...
            <a href="user/booking/seat_plan.php?event_id=9992" class="buy-tickets-btn">Buy Tickets Now</a>
        </div>
    </main>
