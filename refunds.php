        ...
        <div class="help-page-layout">
            ...
            <div class="help-main-content">
                ...
                <div class="help-content">
                    <h3>I've been charged twice, can I get a refund, please?</h3>
                    <p>If you have been charged twice then contact our support team via the contact number.</p>
                    <h3>How do I obtain a refund?</h3>
                    <p>Most of our event partners uphold ticket policy that clarifies that tickets are non-refundable,
                        unless the event is cancelled or the date changed. Please check your event terms & conditions
                        within your email confirmation</p>
                    <p>If you believe you are eligible for a refund, please fill out our <a
                            href="request.php?subject=Refund%20Request"
                            style="color: #004b85; text-decoration: underline; font-weight: bold;">Refund Request
                            Form</a>.</p>
                    <h3>How long will my refund take to reach my account?</h3>
                    <p>Refunds can take between 5-10 working days to reach your account.</p>
                    <p>However, if you've been waiting longer than 10 working days and your refund still hasn't reached
                        you then please contact our customer support team via the Support button at the bottom right of
                        your screen.</p>
                </div>
