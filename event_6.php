...
<head>
    <meta charset="UTF-8">
    <title>Sri Lanka Cricket (SLC) T20 League - Event Details</title>
...
<body>
    ...
    <main class="container">
        <div class="details-container">
            <img src="uploads/event_images/event_img_6967ec5e88a079.92975676.jpeg" class="event-header-img"
                alt="Sri Lanka Cricket (SLC) T20 League">

            <h1 class="event-title">Sri Lanka Cricket (SLC) T20 League</h1>
            ...
            <div class="event-date-badge">
                <i class="far fa-calendar-alt"></i> Date: 2026-07-04
            </div>
            ...
            <a href="user/booking/seat_plan.php?event_id=9995" class="buy-tickets-btn">Buy Tickets Now</a>
        </div>
    </main>
