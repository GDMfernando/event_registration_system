...
<head>
    <meta charset="UTF-8">
    <title>Madhura Jawanika - මධුර ජවනිකා - Event Details</title>
...
<body>
    ...
    <main class="container">
        <div class="details-container">
            <img src="uploads/event_images/madura_jawanika_3.jpg" class="event-header-img"
                alt="Madhura Jawanika - මධුර ජවනිකා">

            <h1 class="event-title">Madhura Jawanika - මධුර ජවනිකා</h1>
            <div class="event-info-meta">
                <span>Theatre</span> |
                <span>Lionel Wendt Art Centre</span> |
                <span>Theatre Hall</span>
            </div>

            <div class="event-date-badge">
                <i class="far fa-calendar-alt"></i> Date: 2026-03-25
            </div>
