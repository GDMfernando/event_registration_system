...
<head>
    <meta charset="UTF-8">
    <title>Sri Lanka Football Premier League - Event Details</title>
...
<body>
    ...
    <main class="container">
        <div class="details-container">
            <img src="uploads/event_images/Sri-Lanka-Football-will-participate-at-South-Asian-Games-FFSL.jpg"
                class="event-header-img" alt="Sri Lanka Football Premier League">

            <h1 class="event-title">Sri Lanka Football Premier League</h1>
            ...
            <div class="event-date-badge">
                <i class="far fa-calendar-alt"></i> Date: 2026-06-19
            </div>
            ...
            <a href="user/booking/seat_plan.php?event_id=9997" class="buy-tickets-btn">Buy Tickets Now</a>
        </div>
    </main>
